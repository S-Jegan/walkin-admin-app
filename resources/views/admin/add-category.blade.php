						...
						<div class="box-widget widget-module">
							...
							<div class="widget-container">
								<div class=" widget-block">
									...
									<form class=" form-horizontal" action="{{URL::to('add-category')}}" method="POST" enctype="multipart/form-data">
								
										<div class="form-group">
											<label class="col-md-3 control-label" for="resume_name1">Enter Category Name</label>
											<div class=" col-md-7">
